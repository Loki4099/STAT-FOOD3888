...
Systolic_df <- data.frame(
    Model = c("GAM", "Robust" ,"Multiple Linear"),
    RMSE = c(mean_systolic_gam_rmse, mean_systolic_robust_rmse,mean_systolic_mlr_rmse),
    MAE = c(mean_systolic_gam_mae, mean_systolic_robust_mae, mean_systolic_mlr_mae),
    R2 = c(mean_systolic_gam_r2, mean_systolic_robust_r2, mean_systolic_mlr_r2)
)
...
SystolicFig <- subplot(Systolic_rmse, Systolic_mae, Systolic_r2, nrows = 1, shareY = FALSE, titleX = TRUE) %>%
  layout(title = list(text = "RMSE Comparison,  MAE Comparison, Figure 6.3: R² Comparison", 
                      font = list(size = 12)))
...
Diastolic_df <- data.frame(
    Model = c("GAM", "Robust" ,"Multiple Linear"),
    RMSE = c(mean_diastolic_gam_rmse, mean_diastolic_robust_rmse,mean_diastolic_mlr_rmse ),
    MAE = c(mean_diastolic_gam_mae, mean_diastolic_robust_mae, mean_diastolic_mlr_mae),
    R2 = c(mean_diastolic_gam_r2, mean_diastolic_robust_r2, mean_diastolic_mlr_r2)
)
...
DiastolicFig <- subplot(
  ...
  layout(title = list(text = " RMSE Comparison,  MAE Comparison,  R² Comparison", 
                      font = list(size = 12)))
...
```{r fig.width= 12, fig.height=14}
# Set up the plotting area to have 3 rows and 2 columns for FiberEnergy (Systolic in first column, Diastolic in second column)
par(mfrow = c(3, 2))  # 3 rows, 2 columns layout

# Define color for FiberEnergy
fiber_color <- "blue"

# Plot for FiberEnergy (Systolic in first column, Diastolic in second column)
plot(systolic_gam_model_light, select = 1, seWithMean = TRUE, shade = TRUE, col = fiber_color, main = "Light BMI Group - Systolic - FiberEnergy")
plot(Diastolic_gam_model_light, select = 1, seWithMean = TRUE, shade = TRUE, col = fiber_color, main = "Light BMI Group - Diastolic - FiberEnergy")

plot(systolic_gam_model_normal, select = 1, seWithMean = TRUE, shade = TRUE, col = fiber_color, main = "Normal BMI Group - Systolic - FiberEnergy")
plot(Diastolic_gam_model_normal, select = 1, seWithMean = TRUE, shade = TRUE, col = fiber_color, main = "Normal BMI Group - Diastolic - FiberEnergy")

plot(systolic_gam_model_heavy, select = 1, seWithMean = TRUE, shade = TRUE, col = fiber_color, main = "Heavy BMI Group - Systolic - FiberEnergy")
plot(Diastolic_gam_model_heavy, select = 1, seWithMean = TRUE, shade = TRUE, col = fiber_color, main = "Heavy BMI Group - Diastolic - FiberEnergy")
...
```
```{r fig.width= 12, fig.height=14}
# Set up the plotting area to have 3 rows and 2 columns for CarbohydrateEnergy (Systolic in first column, Diastolic in second column)
par(mfrow = c(3, 2))  # 3 rows, 2 columns layout

# Define color for CarbohydrateEnergy
carb_color <- "red"

# Plot for CarbohydrateEnergy (Systolic in first column, Diastolic in second column)
plot(systolic_gam_model_light, select = 2, seWithMean = TRUE, shade = TRUE, col = carb_color, main = "Light BMI Group - Systolic - CarbohydrateEnergy")
plot(Diastolic_gam_model_light, select = 2, seWithMean = TRUE, shade = TRUE, col = carb_color, main = "Light BMI Group - Diastolic - CarbohydrateEnergy")

plot(systolic_gam_model_normal, select = 2, seWithMean = TRUE, shade = TRUE, col = carb_color, main = "Normal BMI Group - Systolic - CarbohydrateEnergy")
plot(Diastolic_gam_model_normal, select = 2, seWithMean = TRUE, shade = TRUE, col = carb_color, main = "Normal BMI Group - Diastolic - CarbohydrateEnergy")

plot(systolic_gam_model_heavy, select = 2, seWithMean = TRUE, shade = TRUE, col = carb_color, main = "Heavy BMI Group - Systolic - CarbohydrateEnergy")
plot(Diastolic_gam_model_heavy, select = 2, seWithMean = TRUE, shade = TRUE, col = carb_color, main = "Heavy BMI Group - Diastolic - CarbohydrateEnergy")
