...
```{r}
kept_columns <- kept_columns_df$VariableNames
filtered_X_all_File_variables <- X_all_File_variables[, colnames(X_all_File_variables) %in% kept_columns]

save(filtered_X_all_File_variables, file = "filtered_X_all_File_variables.RData")
```