...
## Drop "LEVELP" column
```{r}
# Drop the columns LEVELP and AGDBBC
filtered_merged_df <- filtered_merged_df[, !(names(filtered_merged_df) %in% c("ABSHID","ABSFID", "ABSLFID", "ABSSID", "ABSBID","LEVELP","ALTNTR","DIABFPGE","DIABPRVE","DIAHBRSK","DIAHMRSK","GGTNTR","GLUCFPD","AGDBBC","DIABBC","DIABQ01A"))]


str(filtered_merged_df)
data <- filtered_merged_df
save(data, file = "ResponseVariables_Cleaned.RData")
>>>>>>> cb0b38266cb12dcf44fd36d225adc1d8d1fa3841
```