...
3. Sensitivity: As the respons variable is the risk of the disease, we wanna reduce the case that the person is actually have risk of hypertension but been predict as not have any risk, so in this case we want to have a smallest Type II error(false negative), sensitivity would be the best measurement in this case.
...
for (i in 1:k_folds) {
  ...
  # Compute accuracy and F1 score for logistic regression
  ...
  # Compute accuracy and F1 score for Random Forest
  ...
  # Compute accuracy and F1 score for SVM
...
# Calculate the average accuracy and F1 score across the 5 folds for logistic regression
avg_logistic_accuracy <- mean(logistic_accuracy)
avg_logistic_f1 <- mean(logistic_f1)

# Calculate the average accuracy and F1 score across the 5 folds for random forest
avg_rf_accuracy <- mean(rf_accuracy)
avg_rf_f1 <- mean(rf_f1)

# Calculate the average accuracy and F1 score across the 5 folds for SVM
avg_svm_accuracy <- mean(svm_accuracy)
avg_svm_f1 <- mean(svm_f1)

# Print the results
cat("Logistic Regression - Average Accuracy:", avg_logistic_accuracy, " Average F1 Score:", avg_logistic_f1, "\n")
cat("Random Forest - Average Accuracy:", avg_rf_accuracy, " Average F1 Score:", avg_rf_f1, "\n")
cat("SVM - Average Accuracy:", avg_svm_accuracy, " Average F1 Score:", avg_svm_f1, "\n")
```
...
# Print the results
cat("Logistic Regression - Average Accuracy:", avg_logistic_accuracy, " Average F1 Score:", avg_logistic_f1, " Average Sensitivity:", avg_logistic_sensitivity, "\n")
cat("Random Forest - Average Accuracy:", avg_rf_accuracy, " Average F1 Score:", avg_rf_f1, " Average Sensitivity:", avg_rf_sensitivity, "\n")
cat("SVM - Average Accuracy:", avg_svm_accuracy, " Average F1 Score:", avg_svm_f1, " Average Sensitivity:", avg_svm_sensitivity, "\n")
