...
model_names1 <- c("Logistic Regression Model A", 
...
combined_coef_plot1 <- wrap_plots(coef_plots, ncol = 3) + 
  plot_annotation(title = "Logistic Regression Coefficient Plots", 
                  theme = theme(plot.title = element_text(size = 16, face = "bold")))

combined_pvalue_plot2 <- wrap_plots(pvalue_plots, ncol = 3) + 
  plot_annotation(title = "Logistic Regression P-Value Plots", 
                  theme = theme(plot.title = element_text(size = 16, face = "bold")))

combined_plot <- wrap_plots(combined_coef_plot1, combined_pvalue_plot2, nrow = 2)
...
model_names2 <- c("Logistic Regression Model a", 
                 "Logistic Regression Model b", 
                 "Logistic Regression Model c")
```
...
combined_coef_plot3 <- wrap_plots(coef_plots, ncol = 3) + 
  plot_annotation(title = "Logistic Regression Coefficient Plots", 
                  theme = theme(plot.title = element_text(size = 16, face = "bold")))

combined_pvalue_plot4 <- wrap_plots(pvalue_plots, ncol = 3) + 
  plot_annotation(title = "Logistic Regression P-Value Plots", 
                  theme = theme(plot.title = element_text(size = 16, face = "bold")))
...
model_names3 <- c("Logistic Regression Model i", 
...
## Group By Gender
```{r}
normalized_data_mele <- normalized_data %>%
  filter(Gender == 1)
