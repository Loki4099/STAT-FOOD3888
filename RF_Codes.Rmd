...
```{r}
rf21 = randomForest(Hypertension ~ BMI + Age + PotassiumSodiumRatio + FiberEnergy + CarbonhydrateEnergy,data = scaled_data, ntree = 500, importance = TRUE, proximity = TRUE)

rf22 = randomForest(Hypertension ~ BMI + Age + PotassiumSodiumRatio + FiberEnergy + CarbonhydrateEnergy,data = scaled_data_light, ntree = 500, importance = TRUE, proximity = TRUE)

rf23 = randomForest(Hypertension ~ BMI + Age + PotassiumSodiumRatio + FiberEnergy + CarbonhydrateEnergy,data = scaled_data_normal, ntree = 500, importance = TRUE, proximity = TRUE)

rf24 = randomForest(Hypertension ~ BMI + Age + PotassiumSodiumRatio + FiberEnergy + CarbonhydrateEnergy,data = scaled_data_heavy, ntree = 500, importance = TRUE, proximity = TRUE)
```


```{r fig.width= 15, fig.height= 18}
models <- list(rf21, rf22, rf23, rf24)
model_names <- c("O", "L", "N", "H")
variables <- c("CarbonhydrateEnergy", "FiberEnergy")
...
print(plots[[1]], split = c(1, 1, 4, 2), more = TRUE)  # First row, first column
print(plots[[2]], split = c(2, 1, 4, 2), more = TRUE)  # First row, second column
print(plots[[3]], split = c(3, 1, 4, 2), more = TRUE)  # First row, third column
print(plots[[4]], split = c(4, 1, 4, 2))               # First row, fourth column
```
